...
def test_search_by_upc_myfood_and_usda(auth_client, app_with_db):
    ...
    response = auth_client.get(f'/search?search_term={upc}&search_usda=true&search_my_foods=true', follow_redirects=True)
...
def test_search_by_upc_recipe_and_usda(auth_client, app_with_db):
    ...
    response = auth_client.get(f'/search?search_term={upc}&search_usda=true&search_recipes=true', follow_redirects=True)
...
def test_search_by_upc_friend_food(auth_client, app_with_db):
    ...
    response = auth_client.get(f'/search?search_term={upc}&search_friends=true', follow_redirects=True)
...
def test_search_by_upc_friend_recipe(auth_client_with_friendship):
    ...
    response = client.get(f'/search?search_term={upc}&search_friends=true', follow_redirects=True)
