...
class MyFoodForm(FlaskForm):
    ...
    protein_per_100g = FloatField(
        "Protein (g per 100g)", validators=[Optional(), NumberRange(min=0)], default=0.0
    )
    ...
    fat_per_100g = FloatField(
        "Fat (g per 100g)", validators=[Optional(), NumberRange(min=0)], default=0.0
    )
    ...
    sodium_mg_per_100g = FloatField(
        "Sodium (mg per 100g)", validators=[Optional(), NumberRange(min=0)], default=0.0
    )
    ...
    iron_mg_per_100g = FloatField(
        "Iron (mg per 100g)", validators=[Optional(), NumberRange(min=0)], default=0.0
    )
